...
TOKEN = ""
...
def enviar_plantilla(to):
    ...
    data = {
        ...
        "type": "template",
        "template": {
            "name": "wasi_app_v2",  # 👈 Nombre exacto de la plantilla
            "language": {
                "code": "es_PE"       # 👈 Código de idioma para Spanish (Perú)
            }
        }
    }
